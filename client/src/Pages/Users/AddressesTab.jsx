        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {addresses.map((address) => (
            <div
              ...
              className={`cursor-pointer relative p-5 rounded-xl border-2 transition-colors group ${
                selectedAddressId === address._id
                  ? "border-primary bg-primary/5 dark:bg-primary/10"
                  : "border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50 hover:border-primary/50"
              }`}
            >
